...
learning_rate = 0.01
threshold = 0.00723674249195426 #optimal netnet threshold @ lr = 0.01
...
with open('ratios_accuracies_netnet.csv', 'wb') as file:
    np.savetxt(file, ratio_accuracy, encoding='utf8', delimiter=',')
with open('ratios_energies_netnet.csv', 'wb') as file:
    np.savetxt(file, ratio_energy, encoding='utf8', delimiter=',')
